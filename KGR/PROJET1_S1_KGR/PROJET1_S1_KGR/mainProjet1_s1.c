...
void main()
{
	...
	cadrant_ptA = DeterminerQuadrant_PointX(ptA_x, ptA_y);
	quadrant_ptB  = DeterminerQuadrant_PointX(ptB_x, ptB_y);
	...
	printf("\n POINT A est a la corrdonnee : [ %f ; %f ] dans le cadrant %d ", ptA_x, ptA_y, cadrant_ptA);
	printf("\n POINT B est a la corrdonnee : [ %f ; %f ] dans le cadrant %d ", ptB_x, ptB_y, quadrant_ptB);
