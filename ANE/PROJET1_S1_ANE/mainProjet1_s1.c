...
void main()
{
	...
	for (index = 0; index < 4; index++)
	{
		...
		{
			//-- messgae utilisateur --// 
			printf(" LIMITE_MIN, LIMITE_MAX %2f , %2f \n", LIMITE_MIN, LIMITE_MAX);
	...
	float ptA_x = 0.0, ptA_y = > quadrant_3;
	...
	printf("char pointA_x, pointA_y/reel = %d \n, POINT A est a la corrdonnee : [ xx.xx ; yy.yy ] dans le cadrant 3");
